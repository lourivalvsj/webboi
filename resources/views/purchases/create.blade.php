...
<div class="container-fluid fade-in-up">
    <div class="page-header-modern">
        <h2><i class="fas fa-shopping-cart me-2"></i>Nova Compra</h2>
    </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="modern-form-group">
                        ...
                        <input type="date" name="purchase_date" class="modern-form-control" value="{{ old('purchase_date') }}">
                        @error('purchase_date')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="modern-form-group">
                        ...
                        <input type="number" step="0.01" name="value" class="modern-form-control" value="{{ old('value') }}" required>
                        @error('value')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="modern-form-group">
                        ...
                        <input type="number" step="0.01" name="freight_cost" class="modern-form-control" value="{{ old('freight_cost') }}">
                        @error('freight_cost')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="modern-form-group">
                        ...
                        <input type="text" name="transporter" class="modern-form-control" value="{{ old('transporter') }}">
                        @error('transporter')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="modern-form-group">
                        ...
                        <input type="number" step="0.01" name="commission_value" class="modern-form-control" value="{{ old('commission_value') }}">
                ...
                <div class="col-md-4">
                    <div class="modern-form-group">
                        ...
                        <input type="number" step="0.01" max="100" name="commission_percent" class="modern-form-control" value="{{ old('commission_percent') }}">
