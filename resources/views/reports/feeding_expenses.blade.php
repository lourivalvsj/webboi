        ...
        <div class="col-12">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-success text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <form action="{{ route('reports.feeding_expenses') }}" method="GET" class="d-inline">
                ...
                <div class="card-body">
                        ...
                        <div class="col-12">
                            <form action="{{ route('reports.feeding_expenses') }}" method="GET" class="row g-3">
                                ...
                                <div class="col-md-2 d-flex align-items-end">
                                    ...
                                    <a href="{{ route('reports.feeding_expenses') }}" class="btn btn-outline-secondary">
                        ...
                        <div class="col-md-3">
                            <div class="card bg-secondary text-white border-0">
                                <div class="card-body text-center">
                                    ...
                                    <small>Custo Médio por Alimentação</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Resumo por Tipo de Alimento -->
                    @if($feedingByType->count() > 0)
                    <div class="row mb-4">
                        <div class="col-12">
                            <h5 class="mb-3"><i class="fas fa-chart-pie me-2"></i>Gastos por Tipo de Alimento</h5>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead class="table-success">
                                        <tr>
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <h5 class="mb-3"><i class="fas fa-shopping-cart me-2"></i>Detalhes das Compras de Alimentação</h5>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <strong class="text-success">R$ {{ number_format($supply->value, 2, ',', '.') }}</strong>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h5 class="mb-3"><i class="fas fa-utensils me-2"></i>Registros de Alimentação do Período</h5>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        @foreach($feedingRecords as $feeding)
                                        <tr>
