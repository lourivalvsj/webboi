        ...
        <div class="col-lg-10">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0"><i class="fas fa-user-plus me-2"></i>Novo Caminhoneiro</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('truck-drivers.store') }}" method="POST" id="truckDriverForm">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="state" id="state" class="form-control @error('state') is-invalid @enderror" 
                                       value="{{ old('state') }}" placeholder="GO" maxlength="2">
                                @error('state')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <!-- Dados do Caminhão -->
                        <div class="section-header">
                            <h5 class="text-primary mb-3"><i class="fas fa-truck me-2"></i>Dados do Caminhão</h5>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="truck_plate" id="truck_plate" class="form-control @error('truck_plate') is-invalid @enderror" 
                                       value="{{ old('truck_plate') }}" placeholder="ABC-1234">
                                @error('truck_plate')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="truck_year" id="truck_year" class="form-control @error('truck_year') is-invalid @enderror" 
                                       value="{{ old('truck_year') }}" min="1980" max="{{ date('Y') + 1 }}">
                                @error('truck_year')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="truck_capacity" id="truck_capacity" 
                                       ...
                                       value="{{ old('truck_capacity') }}" step="0.01" min="0" placeholder="0.00">
                        ...
                        <div class="d-flex justify-content-between pt-3">
                            ...
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-save me-2"></i>Salvar Caminhoneiro
                            </button>
                        </div>
                    </form>
                </div>
